...
var data_set = ['13%', '10%', '26%', '8%', '15%', '9%', '18%', '1%'];

var svg_map2_2 = d3.select(".map2_2")
            .append("svg")
            .attr('width', 200)
            .attr('height', 300);
...
var y = d3.scaleLinear().range([300, 0]);
    ...
    svg_map2_2.data([중구]).append("polygon")
    ...
    svg_map2_2.data([동구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([서구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([남구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([북구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([수성구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([달서구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([달성군1]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_2.data([달성군2]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
