...
var data_set = ['6%', '8%', '25%', '5%', '19%', '26%', '17%', '2%'];

var svg_map2_3 = d3.select(".map2_3")
            .append("svg")
            .attr('width', 200)
            .attr('height', 300);
...
var y = d3.scaleLinear().range([300, 0]);
    ...
    svg_map2_3.data([중구]).append("polygon")
    ...
    svg_map2_3.data([동구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([서구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([남구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([북구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([수성구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([달서구]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([달성군1]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
    ...
    svg_map2_3.data([달성군2]).append("polygon")
                    .attr("points", function (d) {
                            return d.map(function (d) {
                            return [x(d[0]), y(d[1])].join(",");
                        }).join(" ");
